--DDL for IT 378 Exam 2 Part 2

-- This file will create all the tables used IT 378 Exam 2 Part 2
...
--Question 1: 
SET ECHO ON;
SELECT v.VENDOR_NAME "Vendor", COUNT(i.INVOICE_ID) "Num. of Invoices", SUM(i.invoice_total) "Invoice Total"
...
--Question 2: 
SET ECHO ON;
SELECT g.ACCOUNT_DESCRIPTION "Description", Count(*) "Item Count", SUM(i.LINE_ITEM_AMT) "Sum of Line Amounts"
...
HAVING Count(*) > 1
ORDER BY SUM(i.LINE_ITEM_AMT) DESC ;

--Question 3: 
SET ECHO ON;
SELECT v.VENDOR_NAME, COUNT(DISTINCT ili.account_number) "Num of Accounts"
FROM vendors v JOIN invoices i
ON v.VENDOR_ID = i.VENDOR_ID
...
--Question 4:
SET ECHO ON;
SELECT v.VENDOR_STATE, V.VENDOR_CITY, COUNT(i.INVOICE_ID) "INVOICE_QTY", ROUND(AVG(i.invoice_total),2) "INVOICE_AVG"
FROM vendors v JOIN invoices i
ON v.VENDOR_ID = i.VENDOR_ID
...
--Question 5:
SET ECHO ON;
SELECT v.VENDOR_STATE, SUM(i.INVOICE_TOTAL) "SUM_OF_INVOICES"
FROM vendors v JOIN invoices i
ON v.VENDOR_ID = i.VENDOR_ID
